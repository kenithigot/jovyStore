                ...
                <div class=" mt-7 bg-white border border-gray-200 rounded-xl shadow-xl">
                    <div class="p-4 sm:p-7">
                        <div class="text-center gap-x-2">
                            <x-text-gradient class="block text-2xl font-bold text-gray-800">Verify Account
                            </x-text-gradient>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            @else
                                <p class="text-red-600 text-center mt-4">No verification email found. Please register again.
                                </p>
                            @endif
                            <!-- End Form -->
                        </div>
