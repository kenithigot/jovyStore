<x-layouts.app title="Forgot Password - Jovy's Store">
                ...
                <div class=" mt-7 bg-white border border-gray-200 rounded-xl shadow-xl">
                    <div class="p-4 sm:p-7">
                        <div class="text-center gap-x-2">
                            <x-text-gradient class="block text-2xl font-bold text-gray-800">Forgot
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="mt-1 flex flex-col items-center justify-center text-gray-800 text-center">
                        @if(session('success'))
                            ...
                            <div class="animate-spin inline-block size-10 border-3 border-current border-t-transparent text-orange-600 rounded-full"
                        ...
                        @elseif (session('error'))
                            ...
                            <h1 class="pt-1 block text-2xl font-bold text-gray-800">Password Reset Failed</h1>
                            <p class="text-center mt-2 text-sm text-gray-600">
                                {{ session('error') }}
                            </p>
                        @endif
